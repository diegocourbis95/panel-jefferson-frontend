...
const links = [['/dashboard','▦','Dashboard'],['/cobranza','◉','Cuentas por cobrar'],['/clientes','♙','Clientes'],['/calendario','□','Calendario'],['/tareas','✓','Tareas']]
